...
public interface TrafficTreatment {
    ...
    interface Builder {
        ...
        /**
         * Moves NXM_NX_ARP_SHA to NXM_NX_ARP_THA.
         *
         * @return a treatment builder
         */
        Builder moveNxmArpShaToNxmArpTha();

        /**
         * Moves NXM_OF_ETH_SRC to NXM_OF_ETH_DST.
         *
         * @return a treatment builder
         */
        Builder moveNxmEthSrcToNxmEthDst();

        /**
         * Moves move:NXM_OF_ARP_SPA to NXM_OF_ARP_TPA.
         *
         * @return a treatment builder
         */
        Builder moveNxmArpSpaToNxmArpTpa();

        /**
         * Moves NXM_OF_IP_SRC to NXM_OF_IP_DST.
         *
         * @return a treatment builder
         */
        Builder moveNxmIpSrcToNxmIpDst();

        /**
         * Loads the NXM_NX_ARP_SHA.
         *
         * @param addr an mac
         * @return a treatment builder
         */
        Builder loadNxmArpSha(MacAddress addr);

        /**
         * Loads the NXM_OF_ARP_SPA.
         *
         * @param addr an ip
         * @return a treatment builder
         */
        Builder loadNxmArpSpa(IpAddress addr);

        /**
         * Loads the NXM_OF_ARP_OP.
         *
         * @param op a op
         * @return a treatment builder
         */
        Builder loadNxmArpOp(long op);
