...
import org.onosproject.net.flow.instructions.LoadInstruction.LoadSubType;
import org.onosproject.net.flow.instructions.MoveInstruction.NxmArpShaToNxmArpThaInstruction;
import org.onosproject.net.flow.instructions.MoveInstruction.NxmArpSpaToNxmArpTpaInstruction;
import org.onosproject.net.flow.instructions.MoveInstruction.NxmEthSrcToNxmEthDstInstruction;
import org.onosproject.net.flow.instructions.MoveInstruction.NxmIpSrcToNxmIpDstInstruction;
import org.onosproject.net.flow.instructions.LoadInstruction.NxmArpShaInstruction;
import org.onosproject.net.flow.instructions.LoadInstruction.NxmArpOpInstruction;
import org.onosproject.net.flow.instructions.LoadInstruction.NxmArpSpaInstruction;
import org.onosproject.net.flow.instructions.MoveInstruction.MoveSubType;
...
public final class Instructions {
    ...
    /**
     * Creates a NXM_NX_ARP_SHA to NXM_NX_ARP_THA modification.
     *
     * @return a move modification
     */
    public static MoveInstruction moveNxmArpShaToNxmArpTha() {
        return new NxmArpShaToNxmArpThaInstruction(MoveSubType.NXMARPSHATONXMARPTHA);
    }

    /**
     * Creates a NXM_OF_ETH_SRC to NXM_OF_ETH_DST modification.
     *
     * @return a move modification
     */
    public static MoveInstruction moveNxmEthSrcToNxmEthDst() {
        return new NxmEthSrcToNxmEthDstInstruction(MoveSubType.NXMETHSRCTONXMETHDST);
    }

    /**
     * Creates a NXM_OF_ARP_SPA to NXM_OF_ARP_TPA modification.
     *
     * @return a move modification
     */
    public static MoveInstruction moveNxmArpSpaToNxmArpTpa() {
        return new NxmArpSpaToNxmArpTpaInstruction(MoveSubType.NXMARPSPATONXMARPTPA);
    }

    /**
     * Creates a NXM_OF_IP_SRC to NXM_OF_IP_DST modification.
     *
     * @return a move modification
     */
    public static MoveInstruction moveNxmIpSrcToNxmIpDst() {
        return new NxmIpSrcToNxmIpDstInstruction(MoveSubType.NXMIPSRCTONXMIPDST);
    }

    /**
     * Creates a NXM_NX_ARP_SHA modification.
     *
     * @param addr the mac address to modify to
     * @return a Load modification
     */
    public static LoadInstruction loadNxmArpSha(MacAddress addr) {
        return new NxmArpShaInstruction(LoadSubType.NXMARPSHA, addr);
    }
     ...
     * @return a Load modification
     */
    public static LoadInstruction loadNxmArpSpa(IpAddress addr) {
        return new NxmArpSpaInstruction(LoadSubType.NXMARPSPA, addr);
    }

    /**
     * Creates a NXM_NX_ARP_SHA modification.
     *
     * @param addr the op to modify to
     * @return a Load modification
     */
    public static LoadInstruction loadNxmArpOp(long op) {
        return new NxmArpOpInstruction(LoadSubType.NXMARPOP, op);
    }
