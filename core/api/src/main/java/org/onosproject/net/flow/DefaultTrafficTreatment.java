...
public final class DefaultTrafficTreatment implements TrafficTreatment {
    ...
    public static final class Builder implements TrafficTreatment.Builder {
        ...
        @Override
        public TrafficTreatment.Builder moveNxmArpShaToNxmArpTha() {
            return add(Instructions.moveNxmArpShaToNxmArpTha());
        }

        @Override
        public TrafficTreatment.Builder moveNxmEthSrcToNxmEthDst() {
            return add(Instructions.moveNxmEthSrcToNxmEthDst());
        }

        @Override
        public TrafficTreatment.Builder moveNxmArpSpaToNxmArpTpa() {
            return add(Instructions.moveNxmArpSpaToNxmArpTpa());
        }

        @Override
        public TrafficTreatment.Builder moveNxmIpSrcToNxmIpDst() {
            return add(Instructions.moveNxmIpSrcToNxmIpDst());
        }

        @Override
        public TrafficTreatment.Builder loadNxmArpSha(MacAddress addr) {
            return add(Instructions.loadNxmArpSha(addr));
        }

        @Override
        public TrafficTreatment.Builder loadNxmArpSpa(IpAddress addr) {
            return add(Instructions.loadNxmArpSpa(addr));
        }

        @Override
        public TrafficTreatment.Builder loadNxmArpOp(long op) {
            return add(Instructions.loadNxmArpOp(op));
        }
