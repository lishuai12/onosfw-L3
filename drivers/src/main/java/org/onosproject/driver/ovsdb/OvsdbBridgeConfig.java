...
public class OvsdbBridgeConfig extends AbstractHandlerBehaviour
    ...
    @Override
    public void addBridge(BridgeName bridgeName, String exPortName) {
        DriverHandler handler = handler();
        OvsdbClientService clientService = getOvsdbClientService(handler);
        clientService.createBridge(bridgeName.name(), exPortName);
    }
    ...
    public void addPort(String portName) {
        ...
        if (ovsdbSet != null && ovsdbSet.size() > 0) {
            ...
            clientService.createPort(bridge.bridgeName().value(), portName);
        }
    }
    ...
    public void deletePort(String portName) {
        ...
        if (ovsdbSet != null && ovsdbSet.size() > 0) {
            OvsdbBridge bridge = ovsdbSet.iterator().next();
            clientService.dropPort(bridge.bridgeName().toString(), portName);
        }
    }
