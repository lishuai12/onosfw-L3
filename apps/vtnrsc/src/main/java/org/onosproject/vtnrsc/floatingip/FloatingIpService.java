...
public interface FloatingIpService {
    /**
     * Returns exists or not of specific floatingIp id.
     *
     ...
     *
     * @return iterable collection of floating IP
     */
    Iterable<FloatingIp> getFloatingIps();
     ...
     *
     * @param floatingIp the iterable collection of floatingIp
     * @return true if the identifier floatingIp has been created right
     */
    boolean createFloatingIp(Iterable<FloatingIp> floatingIps);
     ...
     */
    boolean updateFloatingIp(Iterable<FloatingIp> floatingIps);

    /**
     * Administratively removes the specified floatingIp from the store.
     *
     * @param floatingIpId the iterable collection of floatingIp identifier
     * @return true if remove identifier floatingIp successfully
     */
    boolean removeFloatingIp(Iterable<FloatingIpId> floatingIpIds);
    /**
     * Add the specified listener to floating Ip map store.
     *
     * @param listener floating Ip listener
     */
    void addListener(EventuallyConsistentMapListener<FloatingIpId, FloatingIp> listener);
    /**
     * Remove the specified listener to floating Ip map store.
     *
     * @param listener floating Ip listener
     */
    void removeListener(EventuallyConsistentMapListener<FloatingIpId, FloatingIp> listener);
}
