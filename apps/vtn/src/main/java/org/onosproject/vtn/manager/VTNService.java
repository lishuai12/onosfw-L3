...
public interface VTNService {
    ...
    /**
     * Applies north south flows when neutron bind or unbind floating ip.
     *
     * @param l3Feedback VtnrscEventFeedback
     * @param type bind or unbind type
     */
    void programFloatingIpEvent(VtnRscEventFeedback l3Feedback, VtnRscEvent.Type type);
