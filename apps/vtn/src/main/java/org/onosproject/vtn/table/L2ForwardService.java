...
public interface L2ForwardService {
    ...
    /**
     * The local broadcast rule that message matches Table(40) Match: broadcast
    ...
    /**
     * The tunnel broadcast rule that message matches Table(40) Match: broadcast
     * mac and vnid Action: output port.
     *
     * @param deviceId Device Id
     * @param segmentationId the vnid of the host belong to
    ...
    /**
     * The local out rule that message matches. Table(40) Match: local host mac
    ...
    /**
     * The tunnel out rule that message matches. Table(40) Match: host mac and
