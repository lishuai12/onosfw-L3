...
public interface ClassifierService {
     ...
     * ingress port Action: set vnid and go to table(40).
     *
    ...
    /**
     * Assemble the L3 Classifier table rules which sended from external port.
     *
     * @param deviceId Device Id
     ...
     */
    void programL3ExPortClassifierRules(DeviceId deviceId, PortNumber exPort,
                                        IpAddress fIp,
                                        Objective.Operation type);

    /**
     * Assemble the L3 Classifier table rules which sended from internal port.
     *
     * @param deviceId Device Id
     * @param inPort the ingress port of the host
     ...
     *
     * @param deviceId Device Id
     * @param srcGwIp source gateway ip
     * @param srcVni the vni of the source network
     * @param type the operation type of the flow rules
     */
    void programArpClassifierRules(DeviceId deviceId, IpAddress srcGwIp,
